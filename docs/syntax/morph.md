...
The upshot of the failure to distinguish between **morph** and **morpheme**
is:

1. By using the term _morpheme_ when morph is meant, one can (like
Huang–Shih) miss a phenomenon like [orthographic alternation](../word-formation/orthographic-alternation.md).
